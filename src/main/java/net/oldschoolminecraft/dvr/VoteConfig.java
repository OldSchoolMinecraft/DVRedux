...
public class VoteConfig extends Configuration
{
    ...
    public void write()
    {
        ...
        generateConfigOption("messages.started", "&7Vote for day has started! &a/vote yes &7or &c/vote no&7.");
        generateConfigOption("messages.succeeded", "&7Vote succeeded! Time will be set to day.");
        generateConfigOption("messages.failed", "&7Vote failed! Time will not be changed.");
        generateConfigOption("messages.startedRain", "&7Vote for rain has started! &a/vote yes &7or &c/vote no&7.");
        generateConfigOption("messages.succeededRain", "&7Vote succeeded! Rain will be turned on.");
        generateConfigOption("messages.alreadyRaining", "&7Vote succeeded but its already raining.");
        generateConfigOption("messages.failedRain", "&7Vote failed! Rain storm will not be turned on.");
    }
